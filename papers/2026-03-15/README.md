...
## 4. AS-Bridge: A Bidirectional Generative Framework Bridging Next-Generation Astronomical Surveys
...
## 6. Fusing Semantic, Lexical, and Domain Perspectives for Recipe Similarity Estimation
...
## 7. A New Modeling to Feature Selection Based on the Fuzzy Rough Set Theory in Normal and Optimistic States on Hybrid Information Systems
...
## 8. Automatic End-to-End Data Integration using Large Language Models
...
## 9. Effective Dataset Distillation for Spatio-Temporal Forecasting with Bi-dimensional Compression
...
## 10. Thousand-GPU Large-Scale Training and Optimization Recipe for AI-Native Cloud Embodied Intelligence Infrastructure
...
## 12. Measuring onion website discovery and Tor users' interests with honeypots
...
## 13. Nezha: A Key-Value Separated Distributed Store with Optimized Raft Integration
...
## 15. MAcPNN: Mutual Assisted Learning on Data Streams with Temporal Dependence
...
## 16. Don't Look Back in Anger: MAGIC Net for Streaming Continual Learning with Temporal Dependence
...
## 17. Query-Guided Analysis and Mitigation of Data Verification Errors (Extended Version)
...
## 18. PRIME: Efficient Algorithm for Token Graph Routing Problem
...
## 19. Seed2Scale: A Self-Evolving Data Engine for Embodied AI via Small to Large Model Synergy and Multimodal Evaluation
...
## 20. Fusion-Poly: A Polyhedral Framework Based on Spatial-Temporal Fusion for 3D Multi-Object Tracking
...
## 21. TS-MLLM: A Multi-Modal Large Language Model-based Framework for Industrial Time-Series Big Data Analysis
...
## 22. Novel Table Search [Technical Report]
...
## 23. AutoResearch-RL: Perpetual Self-Evaluating Reinforcement Learning Agents for Autonomous Neural Architecture Discovery
...
## 24. Seeing the Context: Rich Visual Context-Aware Speech Recognition via Multimodal Reasoning
...
## 25. Single-pass Possibilistic Clustering with Damped Window Footprints
...
## 26. A Hazard-Informed Data Pipeline for Robotics Physical Safety
...
## 27. RESYSTANCE: Unleashing Hidden Performance of Compaction in LSM-trees via eBPF
...
## 28. Engineering Regression Without Real-Data Training: Domain Adaptation for Tabular Foundation Models Using Multi-Dataset Embeddings
...
## 29. The Case for Cardinality Lower Bounds
...
## 30. Stan: An LLM-based thermodynamics course assistant
...
## 31. Synthetic-Child: An AIGC-Based Synthetic Data Pipeline for Privacy-Preserving Child Posture Estimation
...
## 32. The Science Data Lake: A Unified Open Infrastructure Integrating 293 Million Papers Across Eight Scholarly Sources with Embedding-Based Ontology Alignment
...
## 33. DiffusionXRay: A Diffusion and GAN-Based Approach for Enhancing Digitally Reconstructed Chest Radiographs
...
## 34. SEAnet: A Deep Learning Architecture for Data Series Similarity Search
...
## 35. The Gravitational-wave Optical Transient Observer (GOTO) data pipeline and workflow for transient discovery
...
## 36. Trident: Adaptive Scheduling for Heterogeneous Multimodal Data Pipelines
...
## 37. Autoregressive Synthesis of Sparse and Semi-Structured Mixed-Type Data
...
## 38. Contextual Invertible World Models: A Neuro-Symbolic Agentic Framework for Colorectal Cancer Drug Response
...
## 39. Cloud-OpsBench: A Reproducible Benchmark for Agentic Root Cause Analysis in Cloud Systems
...
## 40. Automated Dose-Based Anatomic Region Classification of Radiotherapy Treatment for Big Data Applications
...
## 41. Enhancing Geometric Perception in VLMs via Translator-Guided Reinforcement Learning
...
## 42. Managing Uncertainty in LLM-based Multi-Agent System Operation
...
## 43. Kerr-induced Spectral Interferometry for Direct Ultra-sensitive Phase Recovery
...
## 44. Workload-Aware Incremental Reclustering in Cloud Data Warehouses
...
## 45. Disentangling Shared and Target-Enriched Topics via Background-Contrastive Non-negative Matrix Factorization
...
## 46. Quantum Resistance in Multilayer Graphene-BiFeO3 Memristor for Brain-Inspired Computing
...
## 47. Energy Efficient Federated Learning with Hyperdimensional Computing (HDC)
...
## 48. On Data Engineering for Scaling LLM Terminal Capabilities
...
## 49. Referring Layer Decomposition

**作者**: Fangyi Chen, Yaojie Shen, Lu Xu, Ye Yuan, Shu Zhang
**发布日期**: 2026-02-22
**arXiv ID**: [2602.19358v1](https://arxiv.org/abs/2602.19358v1)
**PDF**: [下载](https://arxiv.org/pdf/2602.19358v1)
**分类**: cs.CV

### 论文摘要

Precise, object-aware control over visual content is essential for advanced image editing and compositional generation. Yet, most existing approaches operate on entire images holistically, limiting the ability to isolate and manipulate individual scene elements. In contrast, layered representations, where scenes are explicitly separated into objects, environmental context, and visual effects, provide a more intuitive and structured framework for interpreting and editing visual content. To bridge...
