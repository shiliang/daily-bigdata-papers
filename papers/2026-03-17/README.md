...
## 1. iDaVIE v1.0: A virtual reality tool for interactive analysis of astronomical data cubes
...
## 2. WhispSynth: Scaling Multilingual Whisper Corpus through Real Data Curation and A Novel Pitch-free Generative Framework
...
## 3. Agentic DAG-Orchestrated Planner Framework for Multi-Modal, Multi-Hop Question Answering in Hybrid Data Lakes
...
## 4. Inevitable Encounters: Backdoor Attacks Involving Lossy Compression
...
## 5. RSEdit: Text-Guided Image Editing for Remote Sensing
...
## 6. ImagiNav: Scalable Embodied Navigation via Generative Visual Prediction and Inverse Dynamics
...
## 8. Nyxus: A Next Generation Image Feature Extraction Library for the Big Data and AI Era
...
## 9. Deep Domain Decomposition Method for Solving the Variational Inequality Problems
...
## 10. WORKSWORLD: A Domain for Integrated Numeric Planning and Scheduling of Distributed Pipelined Workflows
...
## 11. AS-Bridge: A Bidirectional Generative Framework Bridging Next-Generation Astronomical Surveys
...
## 12. Evaluation of LLMs in retrieving food and nutritional context for RAG systems
...
## 13. Fusing Semantic, Lexical, and Domain Perspectives for Recipe Similarity Estimation
...
## 14. A New Modeling to Feature Selection Based on the Fuzzy Rough Set Theory in Normal and Optimistic States on Hybrid Information Systems
...
## 15. Automatic End-to-End Data Integration using Large Language Models
...
## 16. Effective Dataset Distillation for Spatio-Temporal Forecasting with Bi-dimensional Compression
...
## 17. Thousand-GPU Large-Scale Training and Optimization Recipe for AI-Native Cloud Embodied Intelligence Infrastructure
...
## 18. Fish Audio S2 Technical Report
...
## 19. Measuring onion website discovery and Tor users' interests with honeypots
...
## 20. Nezha: A Key-Value Separated Distributed Store with Optimized Raft Integration
...
## 21. Stepping VLMs onto the Court: Benchmarking Spatial Intelligence in Sports
...
## 22. MAcPNN: Mutual Assisted Learning on Data Streams with Temporal Dependence
...
## 23. Don't Look Back in Anger: MAGIC Net for Streaming Continual Learning with Temporal Dependence
...
## 24. Query-Guided Analysis and Mitigation of Data Verification Errors (Extended Version)
...
## 25. PRIME: Efficient Algorithm for Token Graph Routing Problem
...
## 26. Seed2Scale: A Self-Evolving Data Engine for Embodied AI via Small to Large Model Synergy and Multimodal Evaluation
...
## 27. Fusion-Poly: A Polyhedral Framework Based on Spatial-Temporal Fusion for 3D Multi-Object Tracking
...
## 28. TS-MLLM: A Multi-Modal Large Language Model-based Framework for Industrial Time-Series Big Data Analysis
...
## 29. Novel Table Search [Technical Report]
...
## 31. Seeing the Context: Rich Visual Context-Aware Speech Recognition via Multimodal Reasoning
...
## 32. Single-pass Possibilistic Clustering with Damped Window Footprints
...
## 33. A Hazard-Informed Data Pipeline for Robotics Physical Safety
...
## 34. RESYSTANCE: Unleashing Hidden Performance of Compaction in LSM-trees via eBPF
...
## 35. Engineering Regression Without Real-Data Training: Domain Adaptation for Tabular Foundation Models Using Multi-Dataset Embeddings
...
## 36. The Case for Cardinality Lower Bounds
...
## 37. Stan: An LLM-based thermodynamics course assistant
...
## 38. Synthetic-Child: An AIGC-Based Synthetic Data Pipeline for Privacy-Preserving Child Posture Estimation
...
## 39. The Science Data Lake: A Unified Open Infrastructure Integrating 293 Million Papers Across Eight Scholarly Sources with Embedding-Based Ontology Alignment
...
## 40. DiffusionXRay: A Diffusion and GAN-Based Approach for Enhancing Digitally Reconstructed Chest Radiographs
...
## 41. SEAnet: A Deep Learning Architecture for Data Series Similarity Search
...
## 42. The Gravitational-wave Optical Transient Observer (GOTO) data pipeline and workflow for transient discovery
...
## 43. Trident: Adaptive Scheduling for Heterogeneous Multimodal Data Pipelines
...
## 44. Autoregressive Synthesis of Sparse and Semi-Structured Mixed-Type Data
...
## 45. Contextual Invertible World Models: A Neuro-Symbolic Agentic Framework for Colorectal Cancer Drug Response
...
## 46. Cloud-OpsBench: A Reproducible Benchmark for Agentic Root Cause Analysis in Cloud Systems
...
## 47. Automated Dose-Based Anatomic Region Classification of Radiotherapy Treatment for Big Data Applications
...
## 48. Managing Uncertainty in LLM-based Multi-Agent System Operation
...
## 49. Workload-Aware Incremental Reclustering in Cloud Data Warehouses
...
## 50. Disentangling Shared and Target-Enriched Topics via Background-Contrastive Non-negative Matrix Factorization
...
## 51. Should I Hide My Duck in the Lake?
...
## 52. LakeMLB: Data Lake Machine Learning Benchmark
...
## 53. Optimal Bounds-Only Pruning for Spatial AkNN Joins
...
## 54. LakeHopper: Cross Data Lakes Column Type Annotation through Model Adaptation
...
## 55. ByteHouse: A Cloud-Native OLAP Engine with Incremental Computation and Multi-Modal Retrieval
...
## 56. Beyond Text-to-SQL: Autonomous Research-Driven Database Exploration with DAR
...
## 57. Learned Query Optimizer in Alibaba MaxCompute: Challenges, Analysis, and Solutions
...
## 58. Evaluation of Oncotimia: An LLM based system for supporting tumour boards
...
## 59. Create Benchmarks for Data Lakes
...
## 60. A Distributed Spatial Data Warehouse for AIS Data (DIPAAL)
