...
**作者**: Yeounoh Chung, Rushabh Desai, Jian He, Yu Xiao, Thibaud Hottelier
**发布日期**: 2026-03-16
**arXiv ID**: [2603.15970v2](https://arxiv.org/abs/2603.15970v2)
**PDF**: [下载](https://arxiv.org/pdf/2603.15970v2)
**分类**: cs.DB, cs.AI

### 论文摘要

Several data warehouse and database providers have recently introduced extensions to SQL called AI Queries, enabling users to specify functions and conditions in SQL that are evaluated by LLMs, thereby broadening significantly the kinds of queries one can express over the combination of structured and unstructured data. LLMs offer remarkable semantic reasoning capabilities, making them an essential tool for complex and nuanced queries that blend structured and unstructured data. While extremely ...
...
## 4. MFTune: An Efficient Multi-fidelity Framework for Spark SQL Configuration Tuning

**作者**: Beicheng Xu, Lingching Tung, Yuchen Wang, Yupeng Lu, Bin Cui
**发布日期**: 2026-03-17
**arXiv ID**: [2603.16450v1](https://arxiv.org/abs/2603.16450v1)
**PDF**: [下载](https://arxiv.org/pdf/2603.16450v1)
**分类**: cs.DB
...
## 6. TurnWise: The Gap between Single- and Multi-turn Language Model Capabilities
...
**PDF**: [下载](https://arxiv.org/pdf/2603.16759v1)
**分类**: cs.CL, cs.AI
...
## 7. Fanar 2.0: Arabic Generative AI Stack

**作者**: FANAR TEAM, Ummar Abbas, Mohammad Shahmeer Ahmad, Minhaj Ahmad, Abdulaziz Al-Homaid
**发布日期**: 2026-03-17
**arXiv ID**: [2603.16397v1](https://arxiv.org/abs/2603.16397v1)
**PDF**: [下载](https://arxiv.org/pdf/2603.16397v1)
**分类**: cs.CL, cs.AI
...
## 9. AGILE: an end-to-end Rubin-LSST simulation of AGNs, galaxies, and stars I. Software description and first data release

**作者**: A. Viitanen, A. Bongiorno, I. Saccheo, A. Grazian, M. Paolillo
**发布日期**: 2026-03-16
**arXiv ID**: [2603.15729v1](https://arxiv.org/abs/2603.15729v1)
**PDF**: [下载](https://arxiv.org/pdf/2603.15729v1)
**分类**: astro-ph.GA

### 论文摘要

Contemporary large-scale surveys such as the Vera C. Rubin Observatory Legacy Survey of Space and Time (LSST) and Euclid present an unprecedented discovery potential for studying AGNs at the population level in the big data era. However, one major challenge is the accurate identification and classification of AGNs from optical/NIR photometry, or variability data alone. In order to optimize AGN selection, classification, and systematics, as well as to test different data analysis tools, we presen...
...
## 11. WhispSynth: Scaling Multilingual Whisper Corpus through Real Data Curation and A Novel Pitch-free Generative Framework

**作者**: Tianyi Tan, Jiaxin Ye, Yuanming Zhang, Xiaohuai Le, Xianjun Xia
**发布日期**: 2026-03-16
**arXiv ID**: [2603.14853v1](https://arxiv.org/abs/2603.14853v1)
**PDF**: [下载](https://arxiv.org/pdf/2603.14853v1)
**分类**: cs.SD

### 论文摘要

Whisper generation is constrained by the difficulty of data collection. Because whispered speech has low acoustic amplitude, high-fidelity recording is challenging. In this paper, we introduce WhispSynth, a large-scale multilingual corpus constructed via a novel high-fidelity generative framework. Specifically, we propose a pipeline integrating Differentiable Digital Signal Processing (DDSP)-based pitch-free method with Text-to-Speech (TTS) models. This framework refines a comprehensive collecti...
...
## 12. Workload-Aware Incremental Reclustering in Cloud Data Warehouses

**作者**: Yipeng Liu, Renfei Zhou, Jiaqi Yan, Huanchen Zhang
**发布日期**: 2026-02-26
**arXiv ID**: [2602.23289v2](https://arxiv.org/abs/2602.23289v2)
**PDF**: [下载](https://arxiv.org/pdf/2602.23289v2)
**分类**: cs.DB
...
## 14. Inevitable Encounters: Backdoor Attacks Involving Lossy Compression

**作者**: Qian Li, Yunuo Chen, Yuntian Chen
**发布日期**: 2026-03-14
**arXiv ID**: [2603.13864v1](https://arxiv.org/abs/2603.13864v1)
**PDF**: [下载](https://arxiv.org/pdf/2603.13864v1)
**分类**: cs.CR, cs.CV
...
## 15. RSEdit: Text-Guided Image Editing for Remote Sensing

**作者**: Chen Zhenyuan, Zhang Zechuan, Zhang Feng
**发布日期**: 2026-03-14
**arXiv ID**: [2603.13708v1](https://arxiv.org/abs/2603.13708v1)
**PDF**: [下载](https://arxiv.org/pdf/2603.13708v1)
**分类**: cs.CV

### 论文摘要

General-domain text-guided image editors achieve strong photorealism but introduce artifacts, hallucinate objects, and break the orthographic constraints of remote sensing (RS) imagery. We trace this gap to two high-level causes: (i) limited RS world knowledge in pre-trained models, and (ii) conditioning schemes that misalign with the bi-temporal structure and spatial priors of Earth observation data. We present RSEdit, a unified framework that adapts pretrained text-to-image diffusion models - ...
...
## 16. ImagiNav: Scalable Embodied Navigation via Generative Visual Prediction and Inverse Dynamics

**作者**: Jie Chen, Yuxin Cai, Yizhuo Wang, Ruofei Bai, Yuhong Cao
**发布日期**: 2026-03-14
**arXiv ID**: [2603.13833v1](https://arxiv.org/abs/2603.13833v1)
**PDF**: [下载](https://arxiv.org/pdf/2603.13833v1)
**分类**: cs.RO
...
## 17. Multimodal OCR: Parse Anything from Documents
...
## 18. Nyxus: A Next Generation Image Feature Extraction Library for the Big Data and AI Era
...
## 19. Deep Domain Decomposition Method for Solving the Variational Inequality Problems
...
## 20. WORKSWORLD: A Domain for Integrated Numeric Planning and Scheduling of Distributed Pipelined Workflows
...
## 21. AS-Bridge: A Bidirectional Generative Framework Bridging Next-Generation Astronomical Surveys
...
## 22. Evaluation of LLMs in retrieving food and nutritional context for RAG systems
...
## 24. A New Modeling to Feature Selection Based on the Fuzzy Rough Set Theory in Normal and Optimistic States on Hybrid Information Systems
...
## 25. Automatic End-to-End Data Integration using Large Language Models
...
## 26. Effective Dataset Distillation for Spatio-Temporal Forecasting with Bi-dimensional Compression
...
## 27. Thousand-GPU Large-Scale Training and Optimization Recipe for AI-Native Cloud Embodied Intelligence Infrastructure
...
## 28. Fish Audio S2 Technical Report
...
## 29. Measuring onion website discovery and Tor users' interests with honeypots
...
## 30. Nezha: A Key-Value Separated Distributed Store with Optimized Raft Integration
...
## 31. Stepping VLMs onto the Court: Benchmarking Spatial Intelligence in Sports
...
## 32. MAcPNN: Mutual Assisted Learning on Data Streams with Temporal Dependence
...
## 33. Don't Look Back in Anger: MAGIC Net for Streaming Continual Learning with Temporal Dependence
...
## 34. Query-Guided Analysis and Mitigation of Data Verification Errors (Extended Version)
...
## 35. PRIME: Efficient Algorithm for Token Graph Routing Problem
...
## 36. Seed2Scale: A Self-Evolving Data Engine for Embodied AI via Small to Large Model Synergy and Multimodal Evaluation
...
## 37. Fusion-Poly: A Polyhedral Framework Based on Spatial-Temporal Fusion for 3D Multi-Object Tracking
...
## 38. TS-MLLM: A Multi-Modal Large Language Model-based Framework for Industrial Time-Series Big Data Analysis
...
## 39. Novel Table Search [Technical Report]
...
## 40. AutoResearch-RL: Perpetual Self-Evaluating Reinforcement Learning Agents for Autonomous Neural Architecture Discovery
...
## 41. Seeing the Context: Rich Visual Context-Aware Speech Recognition via Multimodal Reasoning
...
## 42. Single-pass Possibilistic Clustering with Damped Window Footprints
...
## 43. A Hazard-Informed Data Pipeline for Robotics Physical Safety
...
## 44. RESYSTANCE: Unleashing Hidden Performance of Compaction in LSM-trees via eBPF
...
## 45. Engineering Regression Without Real-Data Training: Domain Adaptation for Tabular Foundation Models Using Multi-Dataset Embeddings
...
## 46. The Case for Cardinality Lower Bounds
...
## 47. Stan: An LLM-based thermodynamics course assistant
...
## 48. The Science Data Lake: A Unified Open Infrastructure Integrating 293 Million Papers Across Eight Scholarly Sources with Embedding-Based Ontology Alignment
...
## 49. DiffusionXRay: A Diffusion and GAN-Based Approach for Enhancing Digitally Reconstructed Chest Radiographs
...
## 50. SEAnet: A Deep Learning Architecture for Data Series Similarity Search
...
## 51. Autoregressive Synthesis of Sparse and Semi-Structured Mixed-Type Data
...
## 52. Cloud-OpsBench: A Reproducible Benchmark for Agentic Root Cause Analysis in Cloud Systems
...
## 53. Should I Hide My Duck in the Lake?
...
## 54. LakeMLB: Data Lake Machine Learning Benchmark
...
## 55. Optimal Bounds-Only Pruning for Spatial AkNN Joins
...
## 56. LakeHopper: Cross Data Lakes Column Type Annotation through Model Adaptation
...
## 57. ByteHouse: A Cloud-Native OLAP Engine with Incremental Computation and Multi-Modal Retrieval
...
## 58. Beyond Text-to-SQL: Autonomous Research-Driven Database Exploration with DAR
...
## 59. Learned Query Optimizer in Alibaba MaxCompute: Challenges, Analysis, and Solutions
...
## 60. Evaluation of Oncotimia: An LLM based system for supporting tumour boards
